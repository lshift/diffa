---
title: GET diffs/events/:sessionId/:evtSeqId | REST API Documentation
layout: default
---
...
* GET diffs/events/:sessionId/:evtSeqId
...
URL
---
http://server:port/diffa-agent/rest/diffs/events/:sessionId/:evtSeqId
