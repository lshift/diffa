---
title: GET diffs/sessions/:sessionId/scan | REST API Documentation
layout: default
---
...
* GET diffs/sessions/:sessionId/scan
...
<em>Retrieves the scan states of pairs in the current session.</em>
