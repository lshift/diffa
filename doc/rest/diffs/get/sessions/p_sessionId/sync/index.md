---
title: GET diffs/sessions/:sessionId/sync | REST API Documentation
layout: default
---
...
* GET diffs/sessions/:sessionId/sync
...
<em>Retrieves the synchronisation states of pairs in the current session.</em>
