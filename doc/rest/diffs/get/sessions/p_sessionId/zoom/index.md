---
title: GET diffs/sessions/:sessionId/zoom | REST API Documentation
layout: default
---
...
* GET diffs/sessions/:sessionId/zoom
...
URL
---
http://server:port/diffa-agent/rest/diffs/sessions/:sessionId/zoom
