---
title: POST diffs/sessions/:sessionId/scan | REST API Documentation
layout: default
---
...
* POST diffs/sessions/:sessionId/scan
...
<em>Forces Diffa to execute a scan on the pairs underlying the session</em>
...
URL
---
http://server:port/diffa-agent/rest/diffs/sessions/:sessionId/scan
