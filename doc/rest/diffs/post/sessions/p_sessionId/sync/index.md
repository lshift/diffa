---
title: POST diffs/sessions/:sessionId/sync | REST API Documentation
layout: default
---
...
* POST diffs/sessions/:sessionId/sync
...
<em>Forces Diffa to execute a synchronisation operation on the pairs underlying the session</em>
...
URL
---
http://server:port/diffa-agent/rest/diffs/sessions/:sessionId/sync
