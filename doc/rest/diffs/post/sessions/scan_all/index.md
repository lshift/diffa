---
title: POST diffs/sessions/scan_all | REST API Documentation
layout: default
---
...
<em>Forces Diffa to execute a scan operation for every configured pair.</em>
...
URL
---
http://server:port/diffa-agent/rest/diffs/sessions/scan_all
