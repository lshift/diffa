---
title: DELETE config/pairs/:pairKey/escalations/:name | REST API Documentation
layout: default
---
...
* DELETE config/pairs/:pairKey/escalations/:name
...
URL
---
http://server:port/diffa-agent/rest/config/pairs/:pairKey/escalations/:name
