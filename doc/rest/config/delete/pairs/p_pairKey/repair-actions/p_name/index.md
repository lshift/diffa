---
title: DELETE config/pairs/:pairKey/repair-actions/:name | REST API Documentation
layout: default
---
...
* DELETE config/pairs/:pairKey/repair-actions/:name
...
URL
---
http://server:port/diffa-agent/rest/config/pairs/:pairKey/repair-actions/:name
