---
title: POST config/pairs/:id/repair-actions | REST API Documentation
layout: default
---
...
* POST config/pairs/:id/repair-actions
...
URL
---
http://server:port/diffa-agent/rest/config/pairs/:id/repair-actions
