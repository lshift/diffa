---
title: POST config/pairs/:id/escalations | REST API Documentation
layout: default
---
...
* POST config/pairs/:id/escalations
...
URL
---
http://server:port/diffa-agent/rest/config/pairs/:id/escalations
