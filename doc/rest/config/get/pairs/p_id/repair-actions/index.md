---
title: GET config/pairs/:id/repair-actions | REST API Documentation
layout: default
---
...
* GET config/pairs/:id/repair-actions
...
<em>Returns a list of the repair actions associated with a pair</em>

Entity Type
-----------
Array of RepairAction
