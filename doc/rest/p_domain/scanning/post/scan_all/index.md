---
title: POST :domain/scanning/scan_all | REST API Documentation
layout: default
---
...
<em>Forces Diffa to execute a scan operation for every configured pair within this domain.</em>
...
URL
---
http://server:port/diffa-agent/rest/:domain/scanning/scan_all
