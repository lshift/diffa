---
title: POST :domain/config/pairs/:id/repair-actions | REST API Documentation
layout: default
---
...
* POST :domain/config/pairs/:id/repair-actions
...
<em>Creates a new repair action associated with a pair that is registered with the agent.</em>
...
URL
---
http://server:port/diffa-agent/rest/:domain/config/pairs/:id/repair-actions
