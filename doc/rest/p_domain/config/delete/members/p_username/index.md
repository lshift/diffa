---
title: DELETE :domain/config/members/:username | REST API Documentation
layout: default
---
...
* DELETE :domain/config/members/:username
...
<em>Removes the given user from the current domain.</em>
