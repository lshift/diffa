---
title: POST :domain/actions/:pairId/:actionId | REST API Documentation
layout: default
---
...
* POST :domain/actions/:pairId/:actionId
...
<em>Invokes a pair-scoped action on the pair.</em>
...
URL
---
http://server:port/diffa-agent/rest/:domain/actions/:pairId/:actionId
