...
alter table pair  add constraint FK3462DAF68A3C7 foreign key (domain, upstream) references endpoint;
alter table pair  add constraint FK3462DAF2DA557F foreign key (domain, downstream) references endpoint;
